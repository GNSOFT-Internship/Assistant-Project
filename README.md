...
├── .github/workflows/        # backend-tests.yml(pytest), frontend-tests.yml(vitest),
│                             #   deploy.yml(main push 시 테스트 통과 후 서버 자동 배포)
